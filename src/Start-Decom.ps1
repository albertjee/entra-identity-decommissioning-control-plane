...
# v1.4: ValidationOnly switch restored (was dropped in v1.1 — regression fix).
...
Write-DecomConsole -Level 'INFO' -Message "Entra Identity Decommissioning Control Plane v1.4"
